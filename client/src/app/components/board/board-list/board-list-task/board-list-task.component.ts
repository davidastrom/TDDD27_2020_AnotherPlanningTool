...
import { ProfileInfoUser } from 'src/app/components/home/profile-info/profile-info.component';
...
export class BoardListTask {
	_id: string;
	title: string;
	description?: string | null | undefined;
	assigned?: ProfileInfoUser | null | undefined;
}
